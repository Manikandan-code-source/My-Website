  ...
  return (
    <section id="about" className="py-24 relative" ref={sectionRef}>
      <div className="container mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-gray-900 dark:text-white"><span className="text-accent-blue">01.</span> About Me</h2>
        
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="about-text text-gray-700 dark:text-gray-300 text-lg leading-relaxed space-y-6">
            <p>
            ...
            <p>
              Proficient in <span className="text-gray-900 dark:text-white font-medium">React.js, Node.js, Angular.js, MongoDB, PostgreSQL, and AWS</span> cloud infrastructure. I thrive in Agile environments, delivering end-to-end projects from system design to production deployment.
            </p>
            <p>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="about-highlight glass p-6 rounded-2xl flex flex-col justify-center items-center text-center col-span-2">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">Commitment to scalable, secure code</span>
            </div>
          </div>
        </div>
      </div>
